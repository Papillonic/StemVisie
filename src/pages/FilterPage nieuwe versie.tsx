  ...
  const filteredAmendments = useMemo(() => {
    return mockAmendments.filter((a) => {
      ...
      const matchIndiener =
        ...
        (a.indieners || []).some(
          (i) =>
            i.naam.toLowerCase() === indienerNaam.toLowerCase()
        );
      ...
      const matchFractie =
        ...
        (a.indieners || []).some(
          (i) =>
            i.fractie.toLowerCase() === indienerFractie.toLowerCase()
        );
      ...
      const matchCategorie =
        !categorie ||
        (a.Categorie &&
          a.Categorie.toLowerCase().includes(
