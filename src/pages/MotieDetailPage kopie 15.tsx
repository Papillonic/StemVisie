...
const keijzer = mockParties.find(
  (p) => p.abbreviation === "KEI"
);

console.log("KEI party:", keijzer);
console.log(
  "KEI vote:",
  keijzer?.votes?.[current.id]
);
...
console.log("Motie:", current.title);
console.log("Stemdatum:", current.stemDatum);
  ...
  // ===== CHAMBER LAYOUT =====
const chamberLayout =
  getLayoutForDate(current.stemDatum);
...
const hasVote = partyVote !== undefined;
